...
// Main settings
define('SITE_NAME', 'SendThatFile.me'); //The name of your site
define('NONSSL_SITE_URL', 'sendthatfile.me'); //The FQDN of your site
define('SSL_SITE_URL', 'ssl.sendthatfile.me'); //The FQDN of your site, make this different if you are using a subdomain for ssl
define('SITE_IP', '91.121.170.40'); //The IP address by which your site can be publicly accessed
define('SERVER_ROOT', '/var/www/'); //The root of the server, used for includes, purpose is to shorten the path string
define('ANNOUNCE_URL', 'http://'.NONSSL_SITE_URL.':58697'); //Announce URL
...
// Keys
define('ENCKEY', 'qAfreT3aCrezUWRuTre3RUdRUfR9cut4'); //Random key. The key for encryption
define('SITE_SALT', 'CAye3EmACruspECHecA8Red4k7guxUfr'); //Random key. Default site wide salt for passwords, DO NOT LEAVE THIS BLANK/CHANGE AFTER LAUNCH!
define('SCHEDULE_KEY', 'spupreBa5afewReswUneqa2ha964qU3a'); // Random key. This key must be the argument to schedule.php for the schedule to work. 
define('RSS_HASH', 'gu5Ec2epr4ya7uwuyA9a6rEmESpUTaFa'); //Random key. Used for generating unique RSS auth key.

// MySQL details
define('SQLHOST', 'localhost'); //The MySQL host ip/fqdn
define('SQLLOGIN', 'gazelle');//The MySQL login
define('SQLPASS', 'thisISmyPASSwor120'); //The MySQL password
...
define('TRACKER_PORT', 58697);
define('TRACKER_SECRET', '8856$7kAjh8k67jhFk 9jk0h9kjh0k98'); // Must be 32 characters and match site_password in Ocelot's config.cpp
...
// IRC settings
define('BOT_NICK', 'Eowyn');
define('BOT_SERVER', 'irc.sendthatfile.me'); // IRC server address. Used for onsite chat tool.
define('BOT_PORT', 6667);
define('BOT_CHAN', '#'.NONSSL_SITE_URL);
define('BOT_ANNOUNCE_CHAN', '#stf-announce');
define('BOT_STAFF_CHAN', '#stf-staff');
define('BOT_DISABLED_CHAN', '#stf-disabled'); // Channel to refer disabled users to.
define('BOT_HELP_CHAN', '#stf-help');
define('BOT_DEBUG_CHAN', '#stf-debug');
define('BOT_REPORT_CHAN', '#stf-report');
define('BOT_NICKSERV_PASS', '#LadyEowynOfRohan@');
define('SOCKET_LISTEN_PORT', 51010);
define('SOCKET_LISTEN_ADDRESS', 'localhost');
define('ADMIN_CHAN', '#stf-admin');
define('LAB_CHAN', '#stf-labs');
define('STATUS_CHAN', '#stf-status');
...
$Categories    = array('Music'    , 'Applications', 'E-Books'  , 'Audiobooks'   , 'E-Learning Videos', 'TV Shows' , 'Movies'    , 'Comics', 'Games');
$CategoryIcons = array('music.png', 'apps.png'    , 'ebook.png', 'audiobook.png', 'elearning.png'    , 'shows.png', 'movies.png', 'comics.png', 'xxx.png', );
